...
contract OldSchoolArcadeInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the OldSchool Arcade factory
    address public OLDSCHOOL_ARCADE_FACTORY;
    ...
    // The block number when NEON mining ends.
    ...
    constructor() public {
        OLDSCHOOL_ARCADE_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == OLDSCHOOL_ARCADE_FACTORY, "Not factory");
